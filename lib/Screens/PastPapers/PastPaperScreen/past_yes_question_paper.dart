...
class PastPaperYesQuestionPaperScreen extends StatefulWidget {
  const PastPaperYesQuestionPaperScreen({
    super.key,
    required this.list,
    required this.time,
  });
  ...
  @override
  State<PastPaperYesQuestionPaperScreen> createState() =>
      _PastPaperYesQuestionPaperScreenState();
}

class _PastPaperYesQuestionPaperScreenState
    extends State<PastPaperYesQuestionPaperScreen> {
  var quizId;
