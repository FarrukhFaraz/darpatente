...
class _ChapterScreenState extends State<ChapterScreen> {
  ...
  Widget demoLesson() {
    return ListView.builder(
        ...
        shrinkWrap: true,
        itemCount: _capters.length,
        itemBuilder: (context, index) {
          print(_capters[index].chapterId.toString());
          return GestureDetector(
            onTap: () {
              navPush(context, VideoChapterScreen(
                chapterId: _capters[index].chapterId.toString(),
              ));
            },
            child: Container(
              margin: EdgeInsets.only(
              ...
              child: Text(
                _capters[index].chapter!.name.toString(),
                style: TextStyle(
                    fontSize: 24,
                    color: yellow800,
                    fontWeight: FontWeight.w400),
